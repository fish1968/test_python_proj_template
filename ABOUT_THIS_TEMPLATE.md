...
├── test_python_proj_template             # The main python package for the project
...
e.g: `cat test_python_proj_template/VERSION` will get the project version without harming
